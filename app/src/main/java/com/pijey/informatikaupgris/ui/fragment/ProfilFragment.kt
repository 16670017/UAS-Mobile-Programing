        ...
        apiService.getProfil()
                ...
                .subscribe({
                    ...
                    for (i: Int in items.indices) {
                        ...
                        if (BuildConfig.NPM.equals("16670017")) {
                            activity?.let { it1 ->
                                Glide.with(it1).load("https://scontent-sin6-1.xx.fbcdn.net/v/t1.0-9/58994397_1265845710244520_5491074593688911872_n.jpg?_nc_cat=108&_nc_eui2=AeEecWM7vAphgrjoKxJ-EteLUE8a-xsu26ww0mR5sL1uoVxsWcpLTNeci7wVcELDcq604BHGMXFPOvwDWrtN7swCw_qP6AiBGopqchigBiZNjg&_nc_oc=AQl3pINcUyr5RADI3qPIuXJWCS2lFX3QbJUDuxqZfmENQsLdEPVMsjsYnx6Erw3QfXs&_nc_ht=scontent-sin6-1.xx&oh=776c07e45731aa3fc0af4debddcd52fa&oe=5D8171C0")
                                        .override(512, 512).error(R.drawable.error_image).into(ivImageProfile)
                            }
                        }
                    }
